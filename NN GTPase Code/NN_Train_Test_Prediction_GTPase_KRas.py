...
plt.tight_layout()
plt.savefig(f"Actual_vs_Predicted_GTPase_KRas_SV.png", dpi=300)
plt.show()


predicted_values = {}
fda_pred = pd.read_csv("FDA_Hyb_Features.csv")
...
molecules_df = pd.DataFrame(sorted_values[0:30],
